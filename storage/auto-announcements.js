...
// 3) inside start(acc), after scheduleNotifications and backfillReminders, add:

const seenPosts = new Set();

async function checkFacebookPageScrape() {
  try {
...
// start polling
setInterval(checkFacebookPageScrape, 60 * 1000);
checkFacebookPageScrape();
